...
- **GitHub Pages**: Deploy the bundle via docs/ or gh-pages branch with coi-serviceworker.js for cross-origin isolation. _(signals: Git remote: https://github.com/Dicklesworthstone/mcp_agent_mail.git)_
